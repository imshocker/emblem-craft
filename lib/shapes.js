...
<text x="150" y="130" fill="${this.textColor}" font-size="50" text-anchor="middle">${this.text}</text>
</svg>`;
  }
}
...
<text x="150" y="135" fill="${this.textColor}" font-size="50" text-anchor="middle">${this.text}</text>
</svg>`;
  }
}
