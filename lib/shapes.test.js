...
test('Triangle renders SVG with correct colors', () => {
  const triangle = new Triangle('red', 'TEST', 'white');
  expect(triangle.render()).toEqual(`<?xml version="1.0" standalone="no"?>
...
test('Circle renders SVG with correct colors', () => {
  const circle = new Circle('blue', 'TEST', 'white');
  expect(circle.render()).toEqual(`<?xml version="1.0" standalone="no"?>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" height="200" width="300">
...
test('Square renders SVG with correct colors', () => {
  ...
  expect(square.render()).toEqual(`<?xml version="1.0" standalone="no"?>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" height="200" width="300">
